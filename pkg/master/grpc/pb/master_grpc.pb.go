...
const (
	MasterService_Register_FullMethodName = "/master.MasterService/Register"
)
...
type MasterServiceClient interface {
	Register(ctx context.Context, in *Node, opts ...grpc.CallOption) (*RegistrationResponse, error)
}
...
func (c *masterServiceClient) Register(ctx context.Context, in *Node, opts ...grpc.CallOption) (*RegistrationResponse, error) {
...
type MasterServiceServer interface {
	Register(context.Context, *Node) (*RegistrationResponse, error)
...
func (UnimplementedMasterServiceServer) Register(context.Context, *Node) (*RegistrationResponse, error) {
...
func _MasterService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MasterServiceServer).Register(ctx, req.(*Node))
	}
...
var MasterService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/master/grpc/pb/master.proto",
}
